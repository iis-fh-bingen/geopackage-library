...
public class TilesTable extends GpkgTable {
	 ...
	 * @throws Exception
	 * @see {@link #create(BoundingBox, int, int, double, double, String)}
	 * 
	 */
	public boolean create(int tilePixelsXY, String identifier) throws Exception {
		...
		return create(bbox, 18, tilePixelsXY, 0.597165, 0.597165, identifier);
	 ...
	 * @see {@link #create(int)}
	 */
	public boolean create(BoundingBox bbox, int maxZoom, int tilePixelsXY, double pixelDistAtMaxZoomX, double pixelDistAtMaxZoomY, String identifier)
			throws Exception {
