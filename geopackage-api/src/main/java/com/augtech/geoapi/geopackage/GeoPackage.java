...
public class GeoPackage {
	...
	/** A map of possible SQL Field types to {@link com.augtech.geoapi.geopackage.GeoPackage.JavaType} enum values.
	 ...
	 * 
	 * @param tableName The {@linkplain com.augtech.geoapi.geopackage.table.TilesTable#getTableName()} to query
	 ...
	 * @param geomDecoder The type of {@linkplain com.augtech.geoapi.geopackage.geometry.GeometryDecoder} to use.
	 ...
	 * extents are null) 
	 * @param geomDecoder The {@link com.augtech.geoapi.geopackage.geometry.GeometryDecoder} to use for reading feature geometries.
	 * @return A list of {@linkplain SimpleFeature}'s
	 * @throws Exception If the SRS of the supplied {@link BoundingBox} does not match the SRS of
	 * the table being queried.
	 */
	 ...
	 * @param tableType Either {@link com.augtech.geoapi.geopackage.GpkgTable#TABLE_TYPE_FEATURES} || {@link com.augtech.geoapi.geopackage.GpkgTable#TABLE_TYPE_TILES}
	 ...
	 * the GeoPackage.
	 * 
	 * @param tableType Either {@link com.augtech.geoapi.geopackage.GpkgTable#TABLE_TYPE_FEATURES} or {@link com.augtech.geoapi.geopackage.GpkgTable#TABLE_TYPE_TILES}
	...
	public long insertTile(String tableName, byte[] tile, int tileColumn, int tileRow, int zoom) throws Exception {
		...
		if (tileColumn > w || tileColumn < 0 || tileRow > h || tileRow < 0 || w==-1 || h==-1) {
	...
	/** Create a {@linkplain com.augtech.geoapi.geopackage.table.FeaturesTable} from a {@link SimpleFeatureType}
	 * 
	 ...
	 * @throws Exception
	 * @see {@link #insertFeatures(java.util.Collection)} for batch processing many features
	 */
	 ...
	 * {@link #createFeatureTable(String, String, java.util.List, java.util.List, BoundingBox, String, boolean)}
	 ...
	 * @param dcConstraint {@link com.augtech.geoapi.geopackage.table.GpkgDataColumnConstraint.DataColumnConstraint}
	 * 
	 */
