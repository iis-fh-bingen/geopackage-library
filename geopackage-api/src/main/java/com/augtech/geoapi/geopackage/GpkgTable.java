...
public abstract class GpkgTable {
	 ...
	 * {@link com.augtech.geoapi.geopackage.table.TilesTable}.
	 * @param tableConstraints Any constraints that apply to the passed fields. These are SQL constraints, 
	 * <i>not</i> {@linkplain com.augtech.geoapi.geopackage.table.GpkgDataColumnConstraint}'s.
	...
	/** Issue a raw query on this table for a {@linkplain com.augtech.geoapi.geopackage.ICursor}
	 * 
	 ...
	 * @param strWhere A valid where clause, without the 'where'. If <code>Null</code>
	 * all records will be returned (which is not advised!)
	 * @return A list containing a map of {@link com.augtech.geoapi.geopackage.GpkgField}. Each member of the list
