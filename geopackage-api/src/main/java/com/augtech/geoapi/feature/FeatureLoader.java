 ...
 * the {@link #loadFeatures(java.io.InputStream)} method.<p>
...
public abstract class FeatureLoader extends ArrayList<SimpleFeature> {
	 ...
	 * through {@link #loadFeatures(java.io.File, SimpleFeatureType)} ?
	 *  
	 ...
	 * This must be called at the end of {@link #loadFeatures(java.io.InputStream)}
