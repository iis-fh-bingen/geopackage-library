 ...
 * based features. Uses a {@link java.util.concurrent.CopyOnWriteArrayList} to ensure their is no
 * clash with the rendering engined when items are added or removed from the collection.<p>
 * Use {@link #addAll(java.util.Collection)} to maintain speed where possible.
 * 
...
//		}
	 ...
	 * Any new {@link com.augtech.geoapi.feature.type.AttributeTypeImpl} found on the inbound {@link com.augtech.geoapi.feature.type.SimpleFeatureTypeImpl}
	 ...
	 * 
	 * @param from The {@link com.augtech.geoapi.feature.FeatureLoader} containing the source data
